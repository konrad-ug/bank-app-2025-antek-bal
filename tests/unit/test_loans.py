class TestLoans:
    def test_loan_valid_last_three_transactions_personal_account(self, personal_account_simple,
                                                                 other_personal_account_simple):
    ...
    def test_loan_valid_last_five_transactions_personal_account(self, personal_account_simple,
                                                                other_personal_account_simple):
    ...
    def test_loan_valid_last_five_transactions_with_express_transfer_personal_account(self, personal_account_simple,
                                                                                      other_personal_account_simple):
        # testing valid submittion for loan (sum of last 5 transactions is higher than loan)
    ...
    def test_loan_invalid_less_than_five_transactions_personal_account(self, personal_account_simple,
                                                                       other_personal_account_simple):
    ...
    def test_loan_invalid_loan_higher_than_transactions_personal_account(self, personal_account_simple,
                                                                         other_personal_account_simple):
