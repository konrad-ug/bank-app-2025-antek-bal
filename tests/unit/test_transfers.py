class TestTransfers:
    def test_transfer_valid(self, personal_account_valid, personal_account_simple):
        ...
        assert personal_account_valid.history == [
            {"id": 1, "amount": -35, "type": "receiver", "identity": personal_account_simple}]
        assert personal_account_simple.history == [
            {"id": 1, "amount": 35, "type": "sender", "identity": personal_account_valid}]
    ...
    def test_express_transfer_valid_personal(self, personal_account_valid, personal_account_simple):
        ...
        assert personal_account_valid.history == [
            {"id": 1, "amount": -40, "type": "receiver", "identity": personal_account_simple},
            {"id": 2, "amount": -1, "type": "charge", "identity": "express transfer"}]
        assert personal_account_simple.history == [
            {"id": 1, "amount": 40, "type": "sender", "identity": personal_account_valid}]
    ...
    def test_express_transfer_valid_company(self, company_account_first, company_account_second):
        ...
        assert company_account_first.history == [
            {"id": 1, "amount": -30, "type": "receiver", "identity": company_account_second},
            {"id": 2, "amount": -5, "type": "charge", "identity": "express transfer"}]
        assert company_account_second.history == [
            {"id": 1, "amount": 30, "type": "sender", "identity": company_account_first}]
